...
<div x-data="stream()" x-init="init()" class="fixed inset-0 flex w-full h-full">
    ...
    <main class="relative flex-grow">
        ...
        <div class="absolute top-0 right-0 flex mt-2 dark:text-white"
            :class="{'-mr-20 text-black': chat, 'mr-2 text-white': !chat }">
            ...
            <div x-on:click="toggleFullscreen()" class="p-1 cursor-pointer p-1rounded-lg opacity-20 hover:opacity-100">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
