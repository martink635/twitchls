...
@section('content')
<div x-data="stream()" x-init="init()" class="fixed inset-0 flex w-full h-full dark:text-white">
    ...
    <main class="relative flex-grow">
        ...
        <div class="absolute top-0 right-0 flex mt-2 " :class="{'-mr-20 text-black': chat, 'mr-2 text-white': !chat }">
            <div x-on:click="toggleChat()" class="p-1 rounded-lg cursor-pointer opacity-20 hover:opacity-100">
            ...
            <div x-on:click="toggleFullscreen()"
                class="hidden p-1 cursor-pointer md:block p-1rounded-lg opacity-20 hover:opacity-100">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
    ...
    <aside x-show="chat" x-ref="chat" class="absolute h-full md:static">
        <div x-on:click="toggleChat()" class="fixed p-4 rounded-lg cursor-pointer opacity-20 hover:opacity-100">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
                    d="M18 13V5a2 2 0 00-2-2H4a2 2 0 00-2 2v8a2 2 0 002 2h3l3 3 3-3h3a2 2 0 002-2zM5 7a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1zm1 3a1 1 0 100 2h3a1 1 0 100-2H6z"
                    clip-rule="evenodd"></path>
