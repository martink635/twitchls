...
var streams = new Vue({
    ...
    methods: {
         ...
         * @return {void}
         */
        fetchStreams: function fetchStreams(clean) {
            this.loading = true;
            ...
            r.get(api + 'streams/50/' + this.offset + '/' + this.gameURI, (function (data) {
         ...
         * @return {void}
         */
        fetchFollowed: function fetchFollowed() {
            this.followedLoading = true;

            r.get(api + 'followed/50/' + this.offset + '/' + this.identifier, (function (data) {
                this.followed = data;
         ...
         * @return {void}
         */
        resetStreams: function resetStreams() {
            this.streams = [];
            this.page = 0;
        },
         ...
         * @return {void}
         */
        loadMoreStreams: function loadMoreStreams() {
            this.fetchStreams();
        },
         ...
         * @return {void}
         */
        populateGames: function populateGames(data) {
        ...
        fetchSearchResults: function fetchSearchResults() {
            ...
            r.get(api + 'search/' + this.searchQuery, (function (data) {
...
},{"./bootstrap/no-jquery":70,"./components/stream":71,"./modules/browser":73,"./modules/request":74,"./modules/tabs":75,"vue":67}],70:[function(require,module,exports){
'use strict';
...
},{"./template.html":72}],72:[function(require,module,exports){
module.exports = '<a class="col-xs-12 col-sm-6 col-md-4 col-lg-3" href="/{{ stream.channel }}">\n    <img :src="stream.preview" class="img-responsive" alt="">\n    <div class="caption">\n        <div class="stream-title">{{ stream.title }}</div>\n        <div class="stream-description">{{ stream.viewers }} on {{ stream.streamer }}</div>\n    </div>\n</a>\n';
